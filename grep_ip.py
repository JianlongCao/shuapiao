...
URL = 'http://ip.zdaye.com/?ip=&port=&adr=&checktime=1%D0%A1%CA%B1%C4%DA&sleep=&cunhuo=48%D0%A1%CA%B1%D2%D4%C9%CF&nport=&nadr=&dengji=&https=&yys=&gb=&post=&px='
...
#       从页面代码中取出代理 ip和端口
        ...
        ip_re = re.compile(r'(\d{1,3}\.\d{1,3}\.\d{1,3}\.)')
